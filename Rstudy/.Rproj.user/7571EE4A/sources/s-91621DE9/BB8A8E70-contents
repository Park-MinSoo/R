...
korpopmap2@data$name #name들이 다 깨져서 나오게 된다.
Encoding(korpopmap2@data$name) #unknown 임

Encoding(korpopmap2@data$name)<-'UTF-8' # UTF-8을 지정해 준다.
